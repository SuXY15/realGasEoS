# coding: utf-8
"""
Non-Ideal Shock Tube Example from cantera website's example
...
## ========================================
# Plot the result of single IDT process
...
plt.savefig('figs/IDT_nDodecane_1000K_40atm.pdf', dpi=350, format='pdf')
...
## ========================================
## Get IDT of Real Gas under different T
...
## ========================================
## Get IDT of Ideal Gas under different T
...
# If you want to save the plot, uncomment this line (and edit as you see fit):
plt.savefig('figs/NTC_nDodecane_40atm.pdf', dpi=350, format='pdf')
